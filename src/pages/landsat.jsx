...
import { MapPin, Crosshair, Mail, Satellite, ExternalLink, User, AlertTriangle } from 'lucide-react'
...
export default function LandsatTracker() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Tracking set up for:', { locationType, latitude, longitude, notificationMethod })
  }
    ...
    <div className="min-h-screen bg-[#020817] text-white overflow-hidden">
      ...
      <nav className="flex justify-between items-center p-4 bg-opacity-50 bg-black">
        ...
        <div className="flex space-x-4">
          {['HOME', 'ABOUT', 'TRACK', 'NEWS', 'CONTACT'].map((item) => (
            <Link key={item} href="#" className="hover:text-gray-300">{item}</Link>
          ))}
        </div>
      </nav>
      ...
      <section className="flex justify-between items-center p-12">
        <div className="max-w-2xl">
          ...
          <p className="mb-8">Track Landsat satellites and receive notifications when they pass over your location. Explore the beauty of Earth from a new perspective.</p>
        ...
        <div className="relative">
          <img src="/landsat-satellite.png" alt="Landsat Satellite" className="w-96 h-96 object-cover" />
          <canvas ref={canvasRef} className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2" />
        </div>
      </section>
        ...
        <TabsContent value="about">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Earth observation satellite program</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="mb-4">Landsat is a series of Earth observation satellites...</p>
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Supports various applications in agriculture, geology, forestry, and more</li>
              </ul>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="track">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set up notifications for Landsat passes over your location</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <Label>Define Target Location</Label>
                  <RadioGroup value={locationType} onValueChange={setLocationType} className="flex space-x-4 mt-2">
                ...
                <div>
                  ...
                  <RadioGroup value={notificationMethod} onValueChange={setNotificationMethod} className="flex space-x-4 mt-2">
                    <div className="flex items-center space-x-2">
